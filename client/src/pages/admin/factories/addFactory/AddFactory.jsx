...
export default function AddFactory() {
  ...
  return (
    <div className="newFactory">
      <h1 className="newFactoryTitle">New Factory</h1>
      <form className="newFactoryForm">
        <div className="newFactoryItem">
          <label>Factory name</label>
          <input type="text" placeholder="" name="" onChange={handleChange} />
        </div>
        <AddressFilter/>
        <button className="newFactoryButton" onClick={handleClick}>Create</button>
      </form >
    </div >
  );
}
